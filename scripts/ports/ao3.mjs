...
#footer {
  ...
  color: var(--ft-text);
  border-color: var(--ft-surface-hover);
}
#header ul.primary,
#header .primary {
  background-image: none;
...
#header .actions a:focus {
  background-color: var(--ft-surface-hover) !important;
...
#header #search .text {
  ...
  background-image: none !important;
  color: var(--ft-text) !important;
  border: 1px solid var(--ft-surface-active) !important;
...
#dashboard li + li {
  border-top: 1px solid var(--ft-surface-hover);
}
#dashboard a,
#dashboard a:link,
#dashboard a:visited {
...
#dashboard .current {
  background-color: var(--ft-surface-active);
  color: var(--ft-text);
}
...
select:focus {
  ...
  outline: 1px solid var(--ft-accent);
  outline-offset: -1px;
  box-shadow: none;
}
form.verbose legend,
...
.actions label {
  ...
  background-image: none !important;
  color: var(--ft-text) !important;
  border-color: var(--ft-surface-hover) !important;
}
.actions a:hover,
.actions a:focus,
...
a.current,
a:link.current {
  background-color: var(--ft-surface-active) !important;
  background-image: none !important;
  color: var(--ft-text) !important;
...
.filters .expander {
  background-color: var(--ft-bg) !important;
  border-bottom: 1px solid var(--ft-surface-hover) !important;
...
.filters .indicator:before {
  background: var(--ft-bg);
  background-image: none;
  border-color: var(--ft-surface-active);
}
...
.javascript .work.navigation .download .secondary {
  ...
  background-image: none;
  color: var(--ft-text);
  border: 1px solid var(--ft-surface-hover);
  box-shadow: none;
}
...
.resp-sharing-button--bluesky:focus {
  background-color: var(--ft-surface-hover);
}
...
#new_kudo input[type="submit"]:hover,
#new_kudo input[type="submit"]:focus {
...
export default function render(ctx) {
  ...
  const vars = [
    ["bg", sem.bg],
    ["bg-sunken", sem["bg-sunken"]],
    ["surface", sem.surface],
    ["surface-hover", sem["surface-hover"]],
    ["surface-active", sem["surface-active"]],
    ["border", sem.border],
    ["text", sem.text],
    ["text-muted", sem["text-muted"]],
    ["link", sem.link],
    ["link-visited", sem["link-visited"]],
    ["link-hover", sem["link-hover"]],
    ["accent", sem.accent],
    ["pink", sem.cursor],
    ["error", sem.error],
    ["warning", sem.warning],
  ...
  const out = [
    `/* ${meta.name} for AO3. Generated from palette.json. Do not edit by hand. */`,
    ``,
    root,
    ``,
    RULES,
  ...
  return [{ path: "ports/ao3/fadetouched.css", content: out }];
}
